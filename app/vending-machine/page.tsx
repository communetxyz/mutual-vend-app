...
export default function VendingMachinePage() {
  ...
  // Handle BREAD payment success
  useEffect(() => {
    const purchaseStatus = searchParams.get("purchase")
    const trackId = searchParams.get("track")

    if (purchaseStatus === "success" && trackId) {
      toast.success(`BREAD payment successful for Track #${trackId}! Your item will be dispensed.`)
      // Refresh the tracks to update inventory
      refetchTracks()
    }
